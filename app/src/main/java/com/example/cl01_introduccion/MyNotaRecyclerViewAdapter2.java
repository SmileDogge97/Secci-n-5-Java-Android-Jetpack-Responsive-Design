...
import com.example.cl01_introduccion.databinding.FragmentNota2Binding;
...
public class MyNotaRecyclerViewAdapter2 extends RecyclerView.Adapter<MyNotaRecyclerViewAdapter2.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(FragmentNota2Binding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentNota2Binding binding) {
